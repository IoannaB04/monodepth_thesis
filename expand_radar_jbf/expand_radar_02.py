...
This code expands the radar data using the JBF method for filtered data.
'''
...
def run_combine_jbf(dataset_root=cfg.DATASET.DATAROOT,
    ...
    for scene_token, scene_samples in samples_by_scene.items():
        ...
        for my_sample in scene_samples:
            ...
            print(f"\rScene {scene_name} : {current_sample_counter}/{total_samples} \t{base_dir_filtered}", end='', flush=True)
